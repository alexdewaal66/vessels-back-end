...
INSERT INTO vessel_type (super_type_id,
                         name_nl, name_en, desc_nl, desc_en,
                         tonnage_min, tonnage_max, length, beam, height, draft)
VALUES ((SELECT id FROM vessel_type WHERE name_en = 'cargo'),
...
INSERT INTO vessel_type (super_type_id,
                         name_nl, name_en, desc_nl, desc_en,
                         tonnage_min, tonnage_max, length, beam, height, draft)
VALUES ((SELECT id FROM vessel_type WHERE name_en = 'passenger ship'),
...
INSERT INTO vessel_type (super_type_id,
                         name_nl, name_en, desc_nl, desc_en,
                         tonnage_min, tonnage_max, length, beam, height, draft)
VALUES ((SELECT id FROM vessel_type WHERE name_en = 'dry cargo'),
        'Handy size', 'Handy size', null, 'carriers of 28,000–40,000 DWT',
        28000, 40000, null, null, null, null);
...
VALUES ((SELECT id FROM vessel_type WHERE name_en = 'dry cargo'),
        ...
        40000, 50000, null, null, null, null);
...
VALUES ((SELECT id FROM vessel_type WHERE name_en = 'dry cargo'),
        ...
        null, 52000, 294.13, 32.2, 57.91, 12.04);
...
VALUES ((SELECT id FROM vessel_type WHERE name_en = 'dry cargo'),
        ...
        null, 28000, 225.6, 23.8, 35.5, 8.08);
...
VALUES ((SELECT id FROM vessel_type WHERE name_en = 'dry cargo'),
        ...
        20000, 28000, null, null, null, null);
...
INSERT INTO vessel_type (super_type_id,
                         name_nl, name_en, desc_nl, desc_en,
                         tonnage_min, tonnage_max, length, beam, height, draft)
VALUES ((SELECT id FROM vessel_type WHERE name_en = 'liquid cargo'),
        ...
        20, 75000, 115000, null, null, null);
...
VALUES ((SELECT id FROM vessel_type WHERE name_en = 'liquid cargo'),
        ...
        null, 160000, null, 77.49, 68, 20.1);
...
VALUES ((SELECT id FROM vessel_type WHERE name_en = 'liquid cargo'),
        ...
        150000, 320000, null, null, null, null);

...
INSERT INTO vessel_type (owner, super_type_id, name_nl, name_en, desc_nl, desc_en,
                         tonnage_min, tonnage_max, length_oa, beam, height, draft, timestamp)
VALUES ('beheerder', (SELECT vessel_type_id('vessel')), 'passagiersschip', 'passenger ship',
...
INSERT INTO vessel_type (owner, super_type_id, name_nl, name_en, desc_nl, desc_en,
                         tonnage_min, tonnage_max, length_oa, beam, height, draft, timestamp)
VALUES ('beheerder', (SELECT vessel_type_id('vessel')),
        'vrachtschip', 'cargo',
...
INSERT INTO vessel_type (owner, super_type_id, name_nl, name_en, desc_nl, desc_en,
                         tonnage_min, tonnage_max, length_oa, beam, height, draft, timestamp)
VALUES ('deskundige', (SELECT vessel_type_id('cargo')),
...
INSERT INTO vessel_type (owner, super_type_id, name_nl, name_en, desc_nl, desc_en,
                         tonnage_min, tonnage_max, length_oa, beam, height, draft, timestamp)
VALUES ('deskundige', (SELECT vessel_type_id('vessel')),
...
INSERT INTO vessel_type (owner, super_type_id, name_nl, name_en, desc_nl, desc_en,
                         tonnage_min, tonnage_max, length_oa, beam, height, draft, timestamp)
VALUES ('deskundige', (SELECT vessel_type_id('passenger ship')),
...
INSERT INTO vessel_type (super_type_id, name_nl, name_en, desc_nl, desc_en,
                         tonnage_min, tonnage_max, length_oa, beam, height, draft, timestamp)
VALUES ((SELECT vessel_type_id('dry cargo')),
...
INSERT INTO vessel_type (super_type_id, name_nl, name_en, desc_nl, desc_en,
                         tonnage_min, tonnage_max, length_oa, beam, height, draft, timestamp)
VALUES ((SELECT vessel_type_id('liquid cargo')),

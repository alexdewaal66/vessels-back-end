...
INSERT INTO vessel_type (owner, super_type_id, name_nl, name_en, desc_nl, desc_en,
                         tonnage_min, tonnage_max, length_oa, beam, height, draft, timestamp)
VALUES ('alexdewaal', null, 'vaartuig', 'vessel', 'hoofd categorie', 'root category', null, null, null, null, null, null,
        '2022-01-01');

INSERT INTO vessel_type (owner, super_type_id, name_nl, name_en, desc_nl, desc_en,
                         tonnage_min, tonnage_max, length_oa, beam, height, draft, timestamp)
VALUES ('alexdewaal', vessel_type_id('vessel'), 'passagiersschip', 'passenger ship',
        'een schip met als hoofdfunctie het vervoeren van passagiers. Volgens de IMO, Europese en nationale wetten is een passagiersschip een schip dat meer dan 12 passagiers vervoert. Dit zijn dus mensen die niet werkzaam zijn op een schip. Een passagiersschip dient te voldoen aan bijzondere eisen. Zo dient op een zeegaand passagiersschip een arts aan boord te zijn en gelden er speciale veiligheidseisen.',
...
INSERT INTO vessel_type (owner, super_type_id, name_nl, name_en, desc_nl, desc_en,
                         tonnage_min, tonnage_max, length_oa, beam, height, draft, timestamp)
VALUES ('alexdewaal', vessel_type_id('vessel'),
        'vrachtschip', 'cargo',
...
INSERT INTO vessel_type (owner, super_type_id, name_nl, name_en, desc_nl, desc_en,
                         tonnage_min, tonnage_max, length_oa, beam, height, draft, timestamp)
VALUES ('beheerder', vessel_type_id('cargo'),
...
INSERT INTO vessel_type (owner, super_type_id, name_nl, name_en, desc_nl, desc_en,
                         tonnage_min, tonnage_max, length_oa, beam, height, draft, timestamp)
VALUES ('beheerder', vessel_type_id('vessel'),
...
INSERT INTO vessel_type (owner, super_type_id, name_nl, name_en, desc_nl, desc_en,
                         tonnage_min, tonnage_max, length_oa, beam, height, draft, timestamp)
VALUES ('beheerder', vessel_type_id('passenger ship'),
...
INSERT INTO vessel_type (owner, super_type_id, name_nl, name_en, desc_nl, desc_en,
                         tonnage_min, tonnage_max, length_oa, beam, height, draft, timestamp)
VALUES ('deskundige', vessel_type_id('dry cargo'),
...
VALUES ('deskundige', vessel_type_id('dry cargo'),
        ...
        'carriers of 380,000–400,000 DWT up to 24 m (79 ft) draft, 65 m (213 ft) beam and 360 m (1,180 ft) length_oa; these dimensions are limited by port infrastructure in China',
...
VALUES ('deskundige', vessel_type_id('dry cargo'),
        ...
        'upgraded Panama locks with 366 m (1,201 ft) length_oa, 55 m (180 ft) beam, 18 m (59 ft) draft, 120,000 DWT', null,
...
VALUES ('deskundige', vessel_type_id('dry cargo'),
        ...
        'the largest size that can traverse the original locks of the Panama Canal, a 294.13 m (965.0 ft) length_oa, a 32.2 m (106 ft) width, and a 12.04 m (39.5 ft) draft as well as a height limit of 57.91 m (190.0 ft). Limited to 52,000 DWT loaded, 80,000 DWT empty',
...
VALUES ('deskundige', vessel_type_id('dry cargo'),
        ...
        '28,000 DWT the largest vessel that can traverse the St Lawrence Seaway. These are vessels less than 740 feet (225.6 m) in length_oa, 78 feet (23.8 m) wide, and have a draft less than 26.51 feet (8.08 m) and a height above the waterline no more than 35.5 metres (116 ft)',
...
INSERT INTO vessel_type (owner, super_type_id, name_nl, name_en, desc_nl, desc_en,
                         tonnage_min, tonnage_max, length_oa, beam, height, draft, timestamp)
VALUES ('deskundige', vessel_type_id('liquid cargo'),
...
VALUES ('deskundige', vessel_type_id('liquid cargo'),
        ...
        'a naval architecture term for the largest ship measurements capable of transiting the Suez Canal in a laden condition, and is almost exclusively used in reference to tankers. The limiting factors are beam, draft, height (because of the Suez Canal Bridge), and length_oa[1] (even though the canal has no locks)',
